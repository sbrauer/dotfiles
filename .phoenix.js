...
function appStartupMessage(title) {
...
// api.bind('space', MASH, toggleFullscreen);
...
api.bind('s', MASH, function() { App.focusOrStart('Safari'); });
api.bind('s', SUPER, function() { App.focusOrStart('Spotify'); });
