...
" Contains a few minor tweaks by Sam Brauer.
call Pl#Hi#Allocate({
	\ 'base03'         : [8, 0x002b36],
	\ 'base02'         : [0, 0x073642],
	\ 'base01'         : [10, 0x586e75],
...
let g:Powerline#Colorschemes#solarized16_dark_sam#colorscheme= Pl#Colorscheme#Init([
	...
	\ Pl#Hi#Segments(['fileinfo.flags'], {
		...
		\ }),
	\
	\ Pl#Hi#Segments(['branch', 'raw', 'filesize', 'currenttag', 'fullcurrenttag', 'fileformat', 'fileencoding', 'scrollpercent', 'pwd', 'filetype', 'rvm:string', 'rvm:statusline', 'virtualenv:statusline', 'charcode', 'currhigroup', 'lineinfo'], {
		\ 'n': ['base1', 'base02'],
		\ 'N': ['base00', 'base02'],
		\ }),
	\
